...
for data in contracts44fz_data:
    search_engine.index(index="contracts44fz_big_data", body=data)

print("dir ")
directory_data = parse_directory_for_search_engine()
for data in directory_data:
    search_engine.index(index="directory_big_data", body=data)
...
for data in price_offer_data:
    ...
    search_engine.index(index="price_offer_big_data", body=data)
